...
def extract_features_from_jsonl(file_path, output_csv="products_features.csv", limit=None):
    """
    Đọc file JSONL và trích xuất các feature cần thiết để train Content-Based Recommender
    """
    ...
    with open(file_path, "r", encoding="utf-8") as f:
        for i, line in enumerate(f):
            ...
            if not isinstance(detail, dict):  # đảm bảo luôn là dict
                detail = {}
            ...
            # 2. Thông tin sản phẩm (Text features)
